          ...
          <div className="w-full md:w-1/3 flex flex-col flex-grow flex-shrink ">
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg justify-center flex flex-col">
              ...
              <p className="text-gray-800  text-base px-6 mb-5">
                Welcome to the Event Planner! Are you ready to take your event planning
                and management to the next level? Whether you&lsquo;re organizing a
                conference, party, workshop, or any other type of event, our platform is
                here to make the process seamless and hassle-free.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
            <a href="#" className="flex flex-wrap no-underline hover:no-underline">
              ...
              <p className="text-gray-800  text-base px-6 mb-5">
                ...
                details, including the title, description, date, time, and location, all
                in one place. You can easily update event information as needed, ensuring
                your attendees have the latest details at their fingertips.
              </p>
            </a>
          </div>
        </div>
          ...
          <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
            <a href="#" className="flex flex-wrap no-underline hover:no-underline">
              ...
              <p className="text-gray-800  text-base px-6 mb-5">
                ...
                With our intuitive notification system, you&lsquo;ll never miss a beat
                when it comes to event updates, new invitations, or important discussions.
              </p>
            </a>
          </div>
        </div>
          ...
          <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
            <a href="#" className="flex flex-wrap no-underline hover:no-underline">
              ...
              <p className="text-gray-800  text-base px-6 mb-5">
                ...
                seamless collaboration, and exceptional attendee management. Get started
                now and let&rsquo;s make your next event an absolute success!
              </p>
            </a>
          </div>
        </div>
