import { useFacebookAuth } from 'features/authentication/facebook/hooks/useFacebookAuth';

export const FacebookAuth = () => {
  const { onButtonClick } = useFacebookAuth();
  ...
  return (
    ...
    >
      ...
      <span className="text-sm text-white dark:text-gray-200">Log in with facebook</span>
    </button>
  );
};
