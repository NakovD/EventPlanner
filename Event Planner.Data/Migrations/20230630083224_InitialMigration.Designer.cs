...
namespace EventPlanner.Data.Migrations
{
    ...
    [Migration("20230630083224_InitialMigration")]
            ...
            modelBuilder.Entity("EventPlanner.Data.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Report",
                            Date = new DateTime(2023, 6, 30, 11, 32, 24, 287, DateTimeKind.Local).AddTicks(164),
                            ...
                            Location = "Sliven",
                            OrganizerId = 1,
                            Time = new TimeSpan(415442870196),
                            Title = "First event"
                        },
                        new
                        {
                            Id = 2,
                            Category = "Seminar",
                            Date = new DateTime(2023, 8, 30, 11, 32, 24, 287, DateTimeKind.Local).AddTicks(201),
                            ...
                            Location = "Kri4im",
                            OrganizerId = 2,
                            Time = new TimeSpan(415442870204),
                            Title = "Second event"
                        },
                        new
                        {
                            Id = 3,
                            Category = "Party",
                            Date = new DateTime(2023, 9, 30, 11, 32, 24, 287, DateTimeKind.Local).AddTicks(206),
                            ...
                            Location = "Pernik",
                            OrganizerId = 3,
                            Time = new TimeSpan(415442870208),
                            Title = "Third event"
                        });
                });
